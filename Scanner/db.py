...
INFORMATION_DATA = [
    ...
    ("Live ARP", "Listens to is-at packets, using the ARP protocol. Completely silent -- sends no packets, just reads those that are received. <Ether> <ARP op=2 (is-at)>", 0, "MAC & IP addresses of active devices", 99, 100, 1, False),
